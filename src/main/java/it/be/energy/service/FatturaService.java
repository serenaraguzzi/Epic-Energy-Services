...
public class FatturaService {
	...
	public Optional<Fattura> findFatturaById(Long id) throws FatturaException {
	...
	public Fattura updateFattura(Fattura fattura, Long id) throws FatturaException {
	...
	public List<Fattura> findByStatoFatturaId(Long id) {
		return fatturaRepository.findByStatoFatturaId(id);
	}
